...
{
    public partial class FrmPassedReservationList : Form
    {
        public FrmPassedReservationList()
        {
            InitializeComponent();
        }
        ...
        private void FrmPassedReservationList_Load(object sender, EventArgs e)
        {
            ...
            }).Where(y => y.StatusName == "Geçmiş Rezervasyon").ToList();
        }
