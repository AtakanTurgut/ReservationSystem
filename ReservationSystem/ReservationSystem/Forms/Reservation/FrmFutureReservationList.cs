...
{
    public partial class FrmFutureReservationList : Form
    {
        public FrmFutureReservationList()
        {
            InitializeComponent();
        }
        ...
        private void FrmFutureReservationList_Load(object sender, EventArgs e)
        {
            ...
            }).Where(y => y.StatusName == "Rezervasyon Yapıldı").ToList();
        }
