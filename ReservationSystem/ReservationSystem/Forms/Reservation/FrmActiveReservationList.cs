...
{
    public partial class FrmActiveReservationList : Form
    {
        public FrmActiveReservationList()
        {
            InitializeComponent();
        }
        ...
        private void FrmActiveReservationList_Load(object sender, EventArgs e)
        {
           db.Reservations.Load(); /**/
            ...
            }).Where(y => y.StatusName == "Oda Rezerve Edildi").ToList();
        }
